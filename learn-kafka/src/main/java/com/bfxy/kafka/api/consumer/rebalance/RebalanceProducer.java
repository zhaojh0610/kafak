...
public class RebalanceProducer {
    public static void main(String[] args) {
        ...
        properties.put(ProducerConfig.CLIENT_ID_CONFIG, Const.TOPIC_REBALANCE);
        ...
        for (int i = 0; i < 10; i++) {
            ...
            ProducerRecord<String, String> record = new ProducerRecord<String, String>(Const.TOPIC_REBALANCE, JSON.toJSONString(user));
            //  4.发送消息
